...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/hupper-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2540&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hupper-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `hupper` can be installed with:

```
conda install hupper
```

It is possible to list all of the versions of `hupper` available on your platform with:
